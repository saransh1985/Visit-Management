...
const ACCOUNT_CAN_FIELD = 'Customer_Account_Number__c';
...
export default class VisitFlowAccountSelector extends LightningElement {
    ...
    accountPickerDisplayInfo = {
        primaryField: 'Name',
        additionalFields: [ACCOUNT_CAN_FIELD, ACCOUNT_DEALER_CODE_FIELD]
    };
    accountPickerMatchingInfo = {
        primaryField: { fieldPath: 'Name' },
        additionalFields: [{ fieldPath: ACCOUNT_CAN_FIELD }, { fieldPath: ACCOUNT_DEALER_CODE_FIELD }]
    };
