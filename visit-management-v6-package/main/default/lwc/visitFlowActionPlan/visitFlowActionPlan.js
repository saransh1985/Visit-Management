...
export default class VisitFlowActionPlan extends LightningElement {
    ...
    errorText(error) {
        return error?.body?.message || error?.message || 'Something went wrong while loading Meeting Template details.';
    }
    ...
    validate() {
        ...
        return {
            isValid,
            errorMessage: isValid ? null : 'Complete the required Meeting Template fields before finishing.'
        };
    }
}
